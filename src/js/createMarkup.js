...
export async function renderPageMovies(requestAPI = movieAPI) {
  // Робить запит та рендерить розмітку даних
  try {
    const { results, total_pages, total_results } =
      await requestAPI.getMovies(); // Повертає масив фільмів з АРІ
